...
const requiredHtml = [
  ...
  "Nacozari Viejo.<br />Han vivido ahí",
  "estaciones. Nacozari Viejo<br />es una exploración",
  "conexión<br />con la naturaleza y la historia",
  "ha creado<br />un gran legado artístico",
